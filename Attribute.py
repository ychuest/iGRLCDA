...
while counter < 5:
    AllNodeFeatureNum = []
    AllNodeFeatureNumName = 'AllNodeAttribute.csv'
    # print('AllNodeFeatureNumName', AllNodeFeatureNumName)
    ReadMyCsv(AllNodeFeatureNum, AllNodeFeatureNumName)
    AllNodeFeatureNum = np.array(AllNodeFeatureNum)[:, 1:]
...
StorFile(MyNew, 'attribute+manner.csv')
